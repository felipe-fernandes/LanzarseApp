...
class AvailableProductsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_available_products_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                productsListViewModel.products.observe(viewLifecycleOwner) { productsList ->
                    adapter = ProductsListAdapter(productsList)
                }
            }
        }
        return view
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int) =
            AvailableProductsFragment().apply {
